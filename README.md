...
**Final Script Tunneling by WAHYU STORE**
...
## Description
  ...
  WAHYU STORE  is a comprehensive tunneling script designed for setting up and managing VPN services, SSL certificates, UDP configurations, and backups. This script provides tools for various tunneling protocols including OpenVPN, Xray, Shadowsocks, Trojan, VLESS, VMess, and more.
...
### Update Script
```bash
rm -rf /usr/bin/menu_version && rm -rf update.sh && wget -O update.sh https://raw.githubusercontent.com/WAHYUSTORE17/v4/main/update.sh && chmod +x update.sh && ./update.sh
```
### Fix Izin
```bash
...
```bash
wget -O fix-add-ssl.sh https://raw.githubusercontent.com/WAHYUSTORE17/v4/main/fix-add-ssl.sh && chmod +x fix-add-ssl.sh && ./fix-add-ssl.sh
```

### Fix UDP
```bash
wget -O udp.sh https://raw.githubusercontent.com/WAHYUSTORE17/v4/main/udp.sh && chmod +x udp.sh && ./udp.sh
```

### Backup Universal
```bash
wget -O restore-universal.sh https://raw.githubusercontent.com/WAHYUSTORE17/v4/main/Cdy/restore-universal.sh && chmod +x restore-universal.sh && ./restore-universal.sh
```
